...
class PublicVirtualMachineParserSuite extends FunSuite with ByteCodeValues {
  ...
  test("[13] vm parser should parse programs/p01.vm a file into bytecode") {
  ...
  test("[14] vm parser should parse programs/p03.vm a file into bytecode") {
  ...
  test("[15] vm parser should detect a program with invalid bytecode") {
